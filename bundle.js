...
/* harmony import */ var _models_comments_model_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/comments-model.js */ "./src/models/comments-model.js");
...
class API {
  ...
  getFilms() {
    return this._load({url: `movies`})
      ...
      .then(_models_film_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms);
  }

  getComments(id) {
    return this._load({url: `comments/${id}`})
      .then((response) => response.json())
      .then(_models_comments_model_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments);
  }
  ...
  updateFilm(id, data) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_film_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm);
  }
  ...
  addComment(filmData, commentData) {
    return this._load({
      ...
      headers: new Headers({"Content-Type": `application/json`}),
      method: `POST`,
      body: JSON.stringify(_models_comments_model_js__WEBPACK_IMPORTED_MODULE_1__["default"].commentToRaw(commentData)),
    })
      .then((response) => response.json())
      .then(({movie, comments}) => {
        return {
          movie: _models_film_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(movie),
          comments: _models_comments_model_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(comments)
        };
      });
  }
...
class Provider {
  ...
  getFilms() {
    ...
    return Promise.resolve(_models_film_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms(storedFilms));
  }
    ...
    `<li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatCommentDate"])(date)}</span>
  ...
  return (
    `<article class="film-card">
      ...
      <p class="film-card__info">
        ...
        <span class="film-card__duration">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDuration"])(duration)}</span>
...
/* harmony import */ var _components_comment_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/comment.js */ "./src/components/comment.js");
...
const createFilmDetailsTemplate = (filmData, emoji) => {
  ...
  const formatedRelease = moment__WEBPACK_IMPORTED_MODULE_6___default()(release).format(`DD MMMM YYYY`);
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatDuration"])(duration)}</td>
                </tr>
                <tr class="film-details__row">
...
class FilmDetails extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  renderComments(newCommentsData) {
    ...
    this._commentsData.forEach((comment) => {
      const commentComponent = new _components_comment_js__WEBPACK_IMPORTED_MODULE_3__["default"](comment);
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._getCommentsListElement(), commentComponent);
    });
  }
  ...
  setNewCommentHandler() {
    ...
    commentInput.addEventListener(`keydown`, (evt) => {
      if (evt.ctrlKey && evt.key === _const_js__WEBPACK_IMPORTED_MODULE_4__["Keycode"].ENTER_KEY) {
        if (commentInput.value && this._emoji) {
          this._onCommentChange(null, {
            comment: Object(he__WEBPACK_IMPORTED_MODULE_5__["encode"])(commentInput.value),
            date: new Date(),
            emotion: this._emoji,
          });
          commentInput.value = ``;
  ...
  _removeAllComments() {
    this._showedCommentsComponents.forEach((component) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(component));
    this._showedCommentsComponents = [];
  }
...
/***/ "./src/components/footer-stats.js":
/*!****************************************!*\
  !*** ./src/components/footer-stats.js ***!
  \****************************************/
/*! exports provided: default */
...
class FooterStats extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class MainNavigation extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/page-loading.js":
/*!****************************************!*\
  !*** ./src/components/page-loading.js ***!
  \****************************************/
/*! exports provided: default */
...
class PageLoading extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSortTemplate = () => {
  return (
    `<ul class="sort">
      <li><a href="#" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" class="sort__button sort__button--active">Sort by default</a></li>
      <li><a href="#" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}" class="sort__button">Sort by date</a></li>
      <li><a href="#" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}" class="sort__button">Sort by rating</a></li>
    </ul>`
  );
};
...
class Stats extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(filmsModel) {
    super();
    this._filter = _const_js__WEBPACK_IMPORTED_MODULE_3__["StatsFilter"].ALL_TIME;
    this._filmsModel = filmsModel;
  ...
  _renderStatistics() {
    ...
    this._chart = new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(this._context, {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EXTRA_FILMS_COUNT, SHOWING_FILMS_COUNT_ON_START, SHOWING_FILMS_COUNT_BY_BUTTON, AUTHORIZATION, END_POINT, STORE_PREFIX, STORE_VERSION, STORE_NAME, SortType, Keycode, FilterType, PopupMode, StatsFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EXTRA_FILMS_COUNT", function() { return EXTRA_FILMS_COUNT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "STORE_VERSION", function() { return STORE_VERSION; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopupMode", function() { return PopupMode; });
...
const AUTHORIZATION = `Basic HfJ67a21sAjs3Y`;
...
/* harmony import */ var _models_film_model_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/film-model.js */ "./src/models/film-model.js");
...
class FilmController {
  constructor(container, onDataChange, onViewChange) {
    ...
    this._filmData = {};
    this._commentsData = [];
    this._popupMode = _const_js__WEBPACK_IMPORTED_MODULE_8__["PopupMode"].DEFAULT;
  ...
  render(filmData) {
    ...
    this._filmCardComponent = new _components_film_card_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._filmData);
    ...
    this._filmCardComponent.setFavoriteClickHandler((evt) => {
      evt.preventDefault();
      const newFilm = _models_film_model_js__WEBPACK_IMPORTED_MODULE_6__["default"].clone(this._filmData);
    ...
    this._filmCardComponent.setPopupClickHandler(() => {
      this._onViewChange();
      this.setPopup();
      this._popupMode = _const_js__WEBPACK_IMPORTED_MODULE_8__["PopupMode"].OPENED;
    });

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["replace"])(this._filmCardComponent, oldComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._container, this._filmCardComponent);
  }

  setPopup() {
    const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_0__["default"](_const_js__WEBPACK_IMPORTED_MODULE_8__["END_POINT"], _const_js__WEBPACK_IMPORTED_MODULE_8__["AUTHORIZATION"]);
    const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](_const_js__WEBPACK_IMPORTED_MODULE_8__["STORE_NAME"], window.localStorage);
    this._apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);
    this._commentsModel = new _models_comments_model__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._filmDetailsComponent = new _components_film_details_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._filmData, this._onCommentChange);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(body, this._filmDetailsComponent);
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._filmCardComponent);
  }

  setDefaultView() {
    if (this._popupMode !== _const_js__WEBPACK_IMPORTED_MODULE_8__["PopupMode"].DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._filmDetailsComponent);
      this._popupMode = _const_js__WEBPACK_IMPORTED_MODULE_8__["PopupMode"].DEFAULT;
    }
  }
  ...
  _closePopupOnEscPress(evt) {
    if (evt.key === _const_js__WEBPACK_IMPORTED_MODULE_8__["Keycode"].ESC_KEY) {
      this._closePopup();
    }
  }
...
/* harmony import */ var _components_films_extra_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/films-extra.js */ "./src/components/films-extra.js");
...
/* harmony import */ var _components_no_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-films.js */ "./src/components/no-films.js");
/* harmony import */ var _film_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./film-controller.js */ "./src/controllers/film-controller.js");
...
const renderFilms = (container, filmsData, onDataChange, onViewChange) => {
  return filmsData.map((film) => {
    const filmController = new _film_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](container, onDataChange, onViewChange);
...
class PageController {
  constructor(container, filmsModel, api) {
    ...
    this._noFilmsComponent = new _components_no_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._showMoreButtonComponent = new _components_show_more_button_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sortListComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showingFilmsCount = _const_js__WEBPACK_IMPORTED_MODULE_7__["SHOWING_FILMS_COUNT_ON_START"];
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._sortListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFORE);

    if (filmsData.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(filmsContainerElement, this._noFilmsComponent);
      return;
    }
  ...
  _renderShowMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(filmsListElement, this._showMoreButtonComponent);
  }
  ...
  _onShowMoreButtonClick() {
    ...
    this._showingFilmsCount += _const_js__WEBPACK_IMPORTED_MODULE_7__["SHOWING_FILMS_COUNT_BY_BUTTON"];
    const filmsData = this._filmsModel.getFilms();
  ...
  _onFilterChange() {
    this._updateFilms(_const_js__WEBPACK_IMPORTED_MODULE_7__["SHOWING_FILMS_COUNT_ON_START"]);
    this._sortListComponent.returnToDefault();
  }

  _renderExtraFilms() {
    if (this._topRatedFilmsComponent && this._mostCommentedFilmsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._topRatedFilmsComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._mostCommentedFilmsComponent);
    }

    this._topRatedFilmsComponent = new _components_films_extra_js__WEBPACK_IMPORTED_MODULE_0__["default"](EXTRA_FILMS_TITLES.topRated);
    this._mostCommentedFilmsComponent = new _components_films_extra_js__WEBPACK_IMPORTED_MODULE_0__["default"](EXTRA_FILMS_TITLES.mostCommented);
    const container = this._container.getElement();
    ...
    this._topRatedFilmsControllers = renderFilms(this._topRatedFilmsComponent.getFilmsListContainer(),
        Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["getTopRatedFilms"])(filmsData), this._onDataChange, this._onViewChange);

    this._mostCommentedFilmsControllers = renderFilms(this._mostCommentedFilmsComponent.getFilmsListContainer(),
        Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["getMostCommentedFilms"])(filmsData), this._onDataChange, this._onViewChange);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._topRatedFilmsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._mostCommentedFilmsComponent);
  }
}
...
/* harmony import */ var _components_main_navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/main-navigation.js */ "./src/components/main-navigation.js");
/* harmony import */ var _components_page_loading_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/page-loading.js */ "./src/components/page-loading.js");
/* harmony import */ var _components_films_section_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/films-section.js */ "./src/components/films-section.js");
/* harmony import */ var _components_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/footer-stats.js */ "./src/components/footer-stats.js");
/* harmony import */ var _components_stats_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/stats.js */ "./src/components/stats.js");
...
/* harmony import */ var _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./controllers/filter-controller.js */ "./src/controllers/filter-controller.js");
/* harmony import */ var _models_films_model_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/films-model.js */ "./src/models/films-model.js");
...
const renderAfterLoad = (response) => {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(pageLoadingComponent);
  filmsModel.setFilms(response);

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(siteHeaderElement, new _components_profile_rating_js__WEBPACK_IMPORTED_MODULE_2__["default"](filmsModel));
  pageController.render();
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(footerStats, new _components_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__["default"](filmsModel.getAllFilms()));
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(siteMainElement, statsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  statsComponent.hide();
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_0__["default"](_const_js__WEBPACK_IMPORTED_MODULE_13__["END_POINT"], _const_js__WEBPACK_IMPORTED_MODULE_13__["AUTHORIZATION"]);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_11__["default"](_const_js__WEBPACK_IMPORTED_MODULE_13__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);
const filmsModel = new _models_films_model_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
const mainNavigationComponent = new _components_main_navigation_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const statsComponent = new _components_stats_js__WEBPACK_IMPORTED_MODULE_7__["default"](filmsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(siteMainElement, mainNavigationComponent);

const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_9__["default"](mainNavigationComponent.getElement(), filmsModel);
filterController.render();

const filmsSectionComponent = new _components_films_section_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(siteMainElement, filmsSectionComponent);

const pageLoadingComponent = new _components_page_loading_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(filmsSectionComponent.getFilmsListElement(), pageLoadingComponent);

const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](filmsSectionComponent, filmsModel, apiWithProvider);
...
class FilmsModel {
  ...
  getFilmsByWatched(periodName = _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].ALL_TIME) {
    const filmsInHistory = this._films.filter((film) => film.inHistory);

    if (periodName === _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].ALL_TIME) {
    ...
    switch (periodName) {
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].YEAR: {
        date.setFullYear(date.getFullYear() - 1);
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].MONTH: {
        date.setMonth(date.getMonth() - 1);
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].WEEK: {
        date.setDate(date.getDate() - 7);
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["StatsFilter"].TODAY: {
  ...
  getGenresStatistics(filter) {
    ...
    return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["sortObject"])(genres);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInt, getRandomArrayItems, getRandomDate, formatDuration, formatCommentDate, sortObject, getTopRatedFilms, getMostCommentedFilms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTopRatedFilms", function() { return getTopRatedFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMostCommentedFilms", function() { return getMostCommentedFilms; });
...
const formatDuration = (duration) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`).format(`h[h] mm[m]`);
};
...
const getTopRatedFilms = (filmsData) => {
  return filmsData.sort((a, b) => b.rating - a.rating).filter((it, i) => i < _const__WEBPACK_IMPORTED_MODULE_2__["EXTRA_FILMS_COUNT"]);
};

const getMostCommentedFilms = (filmsData) => {
  return filmsData.sort((a, b) => b.comments.length - a.comments.length).filter((it, i) => i < _const__WEBPACK_IMPORTED_MODULE_2__["EXTRA_FILMS_COUNT"]);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getFilmsInWatchlist, getFilmsInHistory, getFilmsInFavorites, getFilmsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsInWatchlist", function() { return getFilmsInWatchlist; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsInHistory", function() { return getFilmsInHistory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsInFavorites", function() { return getFilmsInFavorites; });
